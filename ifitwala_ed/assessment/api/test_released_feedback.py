...
def _released_feedback_stub_modules(
    ...
    task_submission = task_submission_service or types.ModuleType("ifitwala_ed.assessment.api.task_submission")
    ...
    courses = courses_service or types.ModuleType("ifitwala_ed.curriculum.api.courses")
    ...
    return {
        ...
        "ifitwala_ed.assessment.api.task_submission": task_submission,
        "ifitwala_ed.curriculum.api.courses": courses,
...
class TestReleasedFeedbackApi(TestCase):
    def test_student_detail_uses_submission_evidence_as_document_context(self):
        with stubbed_frappe(extra_modules=_released_feedback_stub_modules()) as frappe:
            ...
            module = import_fresh("ifitwala_ed.assessment.api.released_feedback")
