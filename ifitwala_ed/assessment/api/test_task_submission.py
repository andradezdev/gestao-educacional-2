# ifitwala_ed/assessment/api/test_task_submission.py
...
from ifitwala_ed.assessment.api.task_submission import get_latest_submission


class TestTaskSubmissionApi(FrappeTestCase):
    @patch("ifitwala_ed.assessment.api.task_submission._require_authenticated")
    @patch("ifitwala_ed.assessment.api.task_submission._require_student_outcome_access")
    @patch("ifitwala_ed.assessment.api.task_submission.task_feedback_service.build_released_result_payload")
    @patch("ifitwala_ed.assessment.api.task_submission.frappe.get_all")
