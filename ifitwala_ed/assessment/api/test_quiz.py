...
def _quiz_stub_modules():
    courses_stub = types.ModuleType("ifitwala_ed.curriculum.api.courses")
    ...
    return {
        "ifitwala_ed.curriculum.api.courses": courses_stub,
...
class TestQuizApi(TestCase):
    ...
    def setUpClass(cls):
        ...
        with stubbed_frappe(extra_modules=_quiz_stub_modules()):
            cls.quiz_api = import_fresh("ifitwala_ed.assessment.api.quiz")
