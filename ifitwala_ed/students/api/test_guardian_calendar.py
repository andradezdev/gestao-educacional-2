...
from ifitwala_ed.students.api.guardian_calendar import (
...
class TestGuardianCalendarOverlay(FrappeTestCase):
    def test_calendar_overlay_rejects_out_of_scope_school_filter(self):
        ...
        with patch(
            "ifitwala_ed.students.api.guardian_calendar._resolve_guardian_communication_context",
    ...
    def test_calendar_overlay_returns_month_summary_and_filter_options(self):
        ...
        with (
            patch(
                "ifitwala_ed.students.api.guardian_calendar.now_datetime",
            ...
            patch(
                "ifitwala_ed.students.api.guardian_calendar._fetch_guardian_holiday_items",
                return_value=holiday_rows,
            ) as holiday_mock,
            patch(
                "ifitwala_ed.students.api.guardian_calendar._fetch_guardian_school_events",
    ...
    def test_fetch_guardian_holiday_items_matches_children_to_resolved_calendars(self):
        ...
        with (
            patch(
                "ifitwala_ed.students.api.guardian_calendar.resolve_school_calendars_for_window",
                return_value=[
                    {
                        "name": "CAL-PRIMARY",
                        "school": "SCHOOL-1",
