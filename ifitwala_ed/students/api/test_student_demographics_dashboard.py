...
from ifitwala_ed.students.api import student_demographics_dashboard as demographics_dashboard
from ifitwala_ed.students.api.student_demographics_dashboard import get_dashboard, get_slice_entities
...
class TestStudentDemographicsDashboard(FrappeTestCase):
    ...
    def test_active_students_intersects_requested_school_with_authorized_scope(self):
        with (
            patch(
                "ifitwala_ed.students.api.student_demographics_dashboard.get_descendant_schools",
                return_value=["SCH-ROOT", "SCH-CHILD", "SCH-SIBLING"],
            ),
            patch("ifitwala_ed.students.api.student_demographics_dashboard.frappe.db.sql", return_value=[]) as sql,
        ):
    ...
    def test_active_students_uses_instructor_scope_condition_before_aggregation(self):
        with (
            patch(
                "ifitwala_ed.students.api.student_demographics_dashboard.get_instructor_student_scope_condition",
